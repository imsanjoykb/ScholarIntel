...
def home():
    ...
    <div style="display: flex; align-items: center;">
        ...
        <h5>ScholarIntel | Intelligence Decisions Making for Scholar</h5>
        <a href="https://ScholarIntel.pro" target="_self"><button style="background-color: #FF6404; color: #0E0022; border-radius: 10px; padding: 8px 16px; border: none;"><b>Beta Version</b></button></a>
    </div>
    """
    ...
    st.markdown(
        """ 
        <h5 style='text-align:center;'>ScholarIntel is the cutting-edge technologies with solutions of Intelligence Decisons Making Platform for Researchers and Scholars to Empowering Advance and Automate Research Capabilities</h5>
        """,
